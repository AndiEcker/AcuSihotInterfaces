...
| ResPersons<n>Country | String | Country code (ISO2/3) | 'DE', 'ES', 'GB' |
| ResPersons<n>DOB | Date | Birthdate of n-th Occupant | 24-12-1962 |
| ResPersons<n>Email | String | Email address of Occupant | 'name@host.xxx' |
...
| ResPersons<n>Country | - | - | PERSON.COUNTRY-CODE | rgc_country |
| ResPersons<n>DOB | CD_DOB1+CD_DOB2 | - | PERSON.DOB | rgc_dob |
| ResPersons<n>Email | - | - | PERSON.EMAIL | rgc_email |
