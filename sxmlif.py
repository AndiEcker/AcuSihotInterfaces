...
MAP_WEB_RES = \
    (
        ...
        {'elemName': 'GDSNO', 'colName': 'SIHOT_GDSNO'},  # EXT-REFERENCE or VOUCHERNUMBER are not mandatory
        ...
        {'elemName': 'NOPAX', 'colName': 'RU_ADULTS'},
        {'elemName': 'NOCHILDS', 'colName': 'RU_CHILDREN'},
        {'elemName': 'TEC-COMMENT', 'colName': 'SIHOT_TEC_NOTE'},
        {'elemName': 'COMMENT', 'colName': 'SIHOT_NOTE'},
        {'elemName': 'MARKETCODE-NO', 'colName': 'SIHOT_MKT_SEG'},
        # {'elemName': 'MEDIA'},
        {'elemName': 'SOURCE', 'colName': 'RU_SOURCE'},
        {'elemName': 'NN', 'colName': 'RO_SIHOT_SP_GROUP',
         'elemHideIf': "'RO_SIHOT_SP_GROUP' not in c"},
        {'elemName': 'CHANNEL', 'colName': 'RO_SIHOT_RES_GROUP',
        ...
        {'elemName': 'EXT-REFERENCE', 'colName': 'SH_EXT_REF',
         'colValFromAcu': "trim(' ' || RU_FLIGHT_PICKUP || ' ' || RU_FLIGHT_AIRPORT || RU_FLIGHT_NO)"},
        {'elemName': 'ARR-TIME', 'colName': 'RU_FLIGHT_LANDS',
         'elemHideIf': "'RU_FLIGHT_LANDS' not in c"},
        {'elemName': 'PICKUP-TIME-ARRIVAL', 'colName': 'RU_FLIGHT_LANDS',
        ...
        {'elemName': '/PERS-TYPE'},
        {'elemName': '/PERS-TYPE-LIST'},
        {'elemName': 'PERSON/',        # First person/adult of reservation
         'elemHideIf': "c['RU_ADULTS'] <= 0"},
        {'elemName': 'NAME', 'colName': 'SH_ADULT1_NAME', 'colVal': '',
         'elemHideIf': "c['RU_ADULTS'] <= 0 or not c['SH_ADULT1_NAME']"},
        {'elemName': 'NAME2', 'colName': 'SH_ADULT1_NAME2', 'colVal': '',
         'elemHideIf': "c['RU_ADULTS'] <= 0 or not c['SH_ADULT1_NAME2']"},
        {'elemName': 'AUTO-GENERATED', 'colVal': '1',
        ...
        {'elemName': 'GUEST-ID', 'colName': 'CD_SIHOT_OBJID',
         'elemHideIf': "c['RU_ADULTS'] <= 0 or 'CD_SIHOT_OBJID' not in c or not c['CD_SIHOT_OBJID']"},
        {'elemName': 'ROOM-SEQ', 'colVal': '0',
         'elemHideIf': "c['RU_ADULTS'] <= 0"},
        {'elemName': 'ROOM-PERS-SEQ', 'colName': 'SH_PERS_SEQ1', 'colVal': '0',
         'elemHideIf': "c['RU_ADULTS'] <= 0"},
        {'elemName': 'PERS-TYPE', 'colVal': '1A',
         'elemHideIf': "c['RU_ADULTS'] <= 0"},
        {'elemName': 'R', 'colName': 'RUL_SIHOT_PACK',
         'elemHideIf': "c['RU_ADULTS'] <= 0"},
        ...
        {'elemName': '/PERSON',
         'elemHideIf': "c['RU_ADULTS'] <= 0"},
        {'elemName': 'PERSON/',     # Second adult of client
        ...
        {'elemName': '/PERSON',
         'elemHideIf': "c['RU_ADULTS'] <= 1"},
        {'elemName': 'PERSON/',     # Adult 3
         'elemHideIf': "c['RU_ADULTS'] <= 2"},
        {'elemName': 'NAME', 'colName': 'SH_ADULT3_NAME', 'colVal': 'Adult 3',
         'elemHideIf': "c['RU_ADULTS'] <= 2"},
        {'elemName': 'NAME2', 'colName': 'SH_ADULT3_NAME2', 'colVal': '',
         'elemHideIf': "c['RU_ADULTS'] <= 2 or not c['SH_ADULT3_NAME2']"},
        {'elemName': 'AUTO-GENERATED', 'colVal': '1',
         'elemHideIf': "c['RU_ADULTS'] <= 2"},
        {'elemName': 'ROOM-SEQ', 'colVal': '0',
         'elemHideIf': "c['RU_ADULTS'] <= 2"},
        {'elemName': 'ROOM-PERS-SEQ', 'colName': 'SH_PERS_SEQ3', 'colVal': '2',
         'elemHideIf': "c['RU_ADULTS'] <= 2"},
        {'elemName': 'PERS-TYPE', 'colVal': '1A',
         'elemHideIf': "c['RU_ADULTS'] <= 2"},
        {'elemName': 'R', 'colName': 'RUL_SIHOT_PACK',
        ...
        {'elemName': '/PERSON',
         'elemHideIf': "c['RU_ADULTS'] <= 2"},
        {'elemName': 'PERSON/',     # Adult 4
         'elemHideIf': "c['RU_ADULTS'] <= 3"},
        {'elemName': 'NAME', 'colName': 'SH_ADULT4_NAME', 'colVal': 'Adult 4',
         'elemHideIf': "c['RU_ADULTS'] <= 3"},
        {'elemName': 'NAME2', 'colName': 'SH_ADULT4_NAME2', 'colVal': '',
         'elemHideIf': "c['RU_ADULTS'] <= 3 or not c['SH_ADULT4_NAME2']"},
        {'elemName': 'AUTO-GENERATED', 'colVal': '1',
         'elemHideIf': "c['RU_ADULTS'] <= 3"},
        {'elemName': 'ROOM-SEQ', 'colVal': '0',
         'elemHideIf': "c['RU_ADULTS'] <= 3"},
        {'elemName': 'ROOM-PERS-SEQ', 'colName': 'SH_PERS_SEQ4', 'colVal': '3',
         'elemHideIf': "c['RU_ADULTS'] <= 3"},
        {'elemName': 'PERS-TYPE', 'colVal': '1A',
         'elemHideIf': "c['RU_ADULTS'] <= 3"},
        {'elemName': 'R', 'colName': 'RUL_SIHOT_PACK',
        ...
        {'elemName': '/PERSON',
         'elemHideIf': "c['RU_ADULTS'] <= 3"},
        {'elemName': 'PERSON/',     # Adult 5
         'elemHideIf': "c['RU_ADULTS'] <= 4"},
        {'elemName': 'NAME', 'colName': 'SH_ADULT5_NAME', 'colVal': 'Adult 5',
         'elemHideIf': "c['RU_ADULTS'] <= 4"},
        {'elemName': 'NAME2', 'colName': 'SH_ADULT5_NAME2', 'colVal': '',
         'elemHideIf': "c['RU_ADULTS'] <= 4 or not c['SH_ADULT5_NAME2']"},
        {'elemName': 'AUTO-GENERATED', 'colVal': '1',
         'elemHideIf': "c['RU_ADULTS'] <= 4"},
        {'elemName': 'ROOM-SEQ', 'colVal': '0',
         'elemHideIf': "c['RU_ADULTS'] <= 4"},
        {'elemName': 'ROOM-PERS-SEQ', 'colName': 'SH_PERS_SEQ5', 'colVal': '4',
         'elemHideIf': "c['RU_ADULTS'] <= 4"},
        {'elemName': 'PERS-TYPE', 'colVal': '1A',
         'elemHideIf': "c['RU_ADULTS'] <= 4"},
        {'elemName': 'R', 'colName': 'RUL_SIHOT_PACK',
        ...
        {'elemName': '/PERSON',
         'elemHideIf': "c['RU_ADULTS'] <= 4"},
        {'elemName': 'PERSON/',     # Adult 6
         'elemHideIf': "c['RU_ADULTS'] <= 5"},
        {'elemName': 'NAME', 'colName': 'SH_ADULT6_NAME', 'colVal': 'Adult 6',
         'elemHideIf': "c['RU_ADULTS'] <= 5"},
        {'elemName': 'NAME2', 'colName': 'SH_ADULT6_NAME2', 'colVal': '',
         'elemHideIf': "c['RU_ADULTS'] <= 5 or not c['SH_ADULT6_NAME2']"},
        {'elemName': 'AUTO-GENERATED', 'colVal': '1',
         'elemHideIf': "c['RU_ADULTS'] <= 5"},
        {'elemName': 'ROOM-SEQ', 'colVal': '0',
         'elemHideIf': "c['RU_ADULTS'] <= 5"},
        {'elemName': 'ROOM-PERS-SEQ', 'colName': 'SH_PERS_SEQ6', 'colVal': '5',
         'elemHideIf': "c['RU_ADULTS'] <= 5"},
        {'elemName': 'PERS-TYPE', 'colVal': '1A',
         'elemHideIf': "c['RU_ADULTS'] <= 5"},
        {'elemName': 'R', 'colName': 'RUL_SIHOT_PACK',
        ...
        {'elemName': '/PERSON',
         'elemHideIf': "c['RU_ADULTS'] <= 5"},
        {'elemName': 'PERSON/',     # Children 1
         'elemHideIf': "c['RU_CHILDREN'] <= 0"},
        {'elemName': 'NAME', 'colName': 'SH_CHILD1_NAME', 'colVal': 'Child 1',
         'elemHideIf': "c['RU_CHILDREN'] <= 0"},
        {'elemName': 'NAME2', 'colName': 'SH_CHILD1_NAME2', 'colVal': '',
         'elemHideIf': "c['RU_CHILDREN'] <= 0 or not c['SH_CHILD1_NAME2']"},
        {'elemName': 'AUTO-GENERATED', 'colVal': '1',
         'elemHideIf': "c['RU_CHILDREN'] <= 0"},
        {'elemName': 'ROOM-SEQ', 'colVal': '0',
         'elemHideIf': "c['RU_CHILDREN'] <= 0"},
        {'elemName': 'ROOM-PERS-SEQ', 'colName': 'SH_PERS_SEQ11', 'colVal': '10',
         # 'colValFromAcu': "to_char(RU_ADULTS + 0)",  # commented out for optimization - RUNNING SEQ not needed
         'elemHideIf': "c['RU_CHILDREN'] <= 0"},
        {'elemName': 'PERS-TYPE', 'colVal': '2B',
         'elemHideIf': "c['RU_CHILDREN'] <= 0"},
        {'elemName': 'R', 'colName': 'RUL_SIHOT_PACK',
         'elemHideIf': "c['RU_CHILDREN'] <= 0"},
        {'elemName': 'RN', 'colName': 'SIHOT_ROOM_NO',
        ...
        {'elemName': '/PERSON',
         'elemHideIf': "c['RU_CHILDREN'] <= 0"},
        {'elemName': 'PERSON/',     # Children 2
         'elemHideIf': "c['RU_CHILDREN'] <= 1"},
        {'elemName': 'NAME', 'colName': 'SH_CHILD2_NAME', 'colVal': 'Child 2',
         'elemHideIf': "c['RU_CHILDREN'] <= 1"},
        {'elemName': 'NAME2', 'colName': 'SH_CHILD2_NAME2', 'colVal': '',
         'elemHideIf': "c['RU_CHILDREN'] <= 1 or not c['SH_CHILD2_NAME2']"},
        {'elemName': 'AUTO-GENERATED', 'colVal': '1',
         'elemHideIf': "c['RU_CHILDREN'] <= 1"},
        {'elemName': 'ROOM-SEQ', 'colVal': '0',
         'elemHideIf': "c['RU_CHILDREN'] <= 1"},
        {'elemName': 'ROOM-PERS-SEQ', 'colName': 'SH_PERS_SEQ12', 'colVal': '11',
        ...
        {'elemName': '/PERSON',
         'elemHideIf': "c['RU_CHILDREN'] <= 1"},
        {'elemName': 'PERSON/',     # Children 3
         'elemHideIf': "c['RU_CHILDREN'] <= 2"},
        {'elemName': 'NAME', 'colName': 'SH_CHILD3_NAME', 'colVal': 'Child 3',
         'elemHideIf': "c['RU_CHILDREN'] <= 2"},
        {'elemName': 'NAME2', 'colName': 'SH_CHILD3_NAME2', 'colVal': '',
         'elemHideIf': "c['RU_CHILDREN'] <= 2 or not c['SH_CHILD3_NAME2']"},
        {'elemName': 'AUTO-GENERATED', 'colVal': '1',
         'elemHideIf': "c['RU_CHILDREN'] <= 2"},
        {'elemName': 'ROOM-SEQ', 'colVal': '0',
         'elemHideIf': "c['RU_CHILDREN'] <= 2"},
        {'elemName': 'ROOM-PERS-SEQ', 'colName': 'SH_PERS_SEQ13', 'colVal': '12',
        ...
        {'elemName': '/PERSON',
         'elemHideIf': "c['RU_CHILDREN'] <= 2"},
        {'elemName': 'PERSON/',     # Children 4
         'elemHideIf': "c['RU_CHILDREN'] <= 3"},
        {'elemName': 'NAME', 'colName': 'SH_CHILD4_NAME', 'colVal': 'Child 4',
         'elemHideIf': "c['RU_CHILDREN'] <= 3"},
        {'elemName': 'NAME2', 'colName': 'SH_CHILD4_NAME2', 'colVal': '',
         'elemHideIf': "c['RU_CHILDREN'] <= 3 or not c['SH_CHILD4_NAME2']"},
        {'elemName': 'AUTO-GENERATED', 'colVal': '1',
         'elemHideIf': "c['RU_CHILDREN'] <= 3"},
        {'elemName': 'ROOM-SEQ', 'colVal': '0',
         'elemHideIf': "c['RU_CHILDREN'] <= 3"},
        {'elemName': 'ROOM-PERS-SEQ', 'colName': 'SH_PERS_SEQ14', 'colVal': '13',
