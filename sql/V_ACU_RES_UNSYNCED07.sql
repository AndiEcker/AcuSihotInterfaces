...
/*
  ae:12-07-16 first beta of unsynced reservation changes to be synced to SiHOT.
  ...
  ae:05-08-16 V02: refactored to use new RU_SIHOT/AP_SIHOT columns (CPA-pseudo resort in BHC/F004..., optimizing and managing ARO overloads) - later also refactored/split in V_ACU_RES_DATA.
  ...
  ae:17-09-17 V06: added RUL_DATE in order by clause to ensure correct order for receycled/reused T_RUL records (done by P_RUL_INSERT()).
