...
WatchPupPy.exe --cmdInterval=0 --cmdLine="AcuServer.exe --acuDSN=SP.TEST --serverIP=localhost --serverPort=11000 -D=1 -L=log\AcuSrv%log_name%" -D1 -L=log\WatchAcuSrv%log_name%
