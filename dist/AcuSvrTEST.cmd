...
WatchPupPy.exe --cmdInterval=0 --cmdLine="AcuServer.exe --acuDSN=SP.TEST --serverIP=10.103.222.72 --serverPort=11000 -D=1 -L=log\AcuSrv%log_name%" --acuDSN=""  -D1 -L=log\WatchAcuSrv%log_name%
