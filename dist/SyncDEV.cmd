...
WatchPupPy.exe --cmdLine="SihotResSync.exe --acuDSN=SP.DEV --serverIP=10.103.222.71 --clientsFirst=0 --breakOnError=0 -D=1 -L=log\Sync%log_name%" -D2 -L=log\SyncWatch%log_name%